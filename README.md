...
Rischio Moderato: Desametasone + Anti-5HT3
...
-Melanoma in setting adiuvante, inoperabile o metastatico
...
-Carcinoma della mammella (donne in post-menopausa) stadio avanzato/metastatico in progressione/recidiva dopo Tamoxifene
-Fulvestrant
...
•Cemiplimab:
•K squamocellulare su cute localmente avanzato o metastatico non candidabili ad ulteriore intervento chirurgico o radioterapia
...
-Adenocarcinoma:
•Varianti: lesione preinvasiva (Iperplasia adenomatosa atipica, Adenocarcinoma in situ mucinoso e non mucinoso) Adenocarcinoma minimamente invasivo e Adenocarcinoma invasivo •Immunoistochimica: TTF-1, CK7 e napsina positiva
-Stadio IA:
•T1N0M0
...
•(Riarrangiamento di) ROS1: Crizotinib o Entrectinib
...
Se progressione durante o dopo trattamento di I Linea: -Valutazione dell’intervallo dalla ﬁne della precedente chemioterapia:
...
->70/75aa, PS ECOG 0 RAS/BRAF mutato: FOLFOX o FOLFIRI (doppiette) + Bevacizumab
...
•Pz ﬁt: —> Metastasi resecabili: Resezione metastasi dopo Chemio
	    —> Metastasi non resecabili: se potenzialmente resecabili dopo 	 	 	  	    trattamento chemioterapico allora —> Chemioterapia di conversione a 	 		    scopo citoriduttivo altrimenti —> Chemioterapia esclusiva
...
—> T1b (con fattori di rischio) e T2, N0: Chirurgia: ESOFAGECTOMIA transtoracica secondo Ivon-Lewis
...
•Deruxtecan in monoterapia in pz con K Stomaco o Giunzione GE avanzata con precedente trattamento con Trastuzumab
—> se HER2 negativo
...
+CT adiuvante
—> paziente ﬁt (Buone condizioni generali, <70aa, R0/1): FOLFIRINOX x 6Mesi (diverso dosaggio da FOLFOXIRI, colon)
...
MIBC (T2-T4a, cN0, cM0) -Chemioterapia neoadivuante: 
...
Usati per terapia di metastasi e prevenzione/trattamento osteoporosi da ADT
...
Terapia adiuvante: Terapia adiuvante valutata in base alle classi di rischio (Età >60aa, Invasione spazi linfovascolari LVSI, Stadio, Istologia, Linfonodi e Grado), valide dallo stadio I al IVa:
...
•La scelta del trattamento dipende prevalentemente da ragioni cliniche (età e condizioni generali della paziente, stato pre o postmenopausale, obesità), oncologiche (istologia, dimensioni della neoplasia, rischio di localizzazioni linfonodali), esperienza delle singole istituzioni.
...
Malattia localmente avanzata (stadio III)(Da T1b se LN Sentinella+) Chirurgia + LINFADENECTOMIA
...
•La RT adiuvante (rispetto a quella in caso di recidiva): migliora la PFS, la sopravvivenza mediana di circa 2 anni ma ha uno scarso impatto sull’Overall Survival
•TMZ non cambia la probabilità di sopravvivenza (OS) ma evita la progressione di malattia (PFS) Rispetto a PCV
•Non diﬀerenza tra TMZ e RT 54Gy in termini di Quality of Life
•IDH mutato: migliore OS (rispetto al wild type)
•Codelezione 1p/19q: peso stadiativo e di orientamento della terapia
•Astrocitomi: data la minore sensibilità alla TMZ danno recidiva precoce e OS breve
•RT massima somministrabile in SNC: 60Gy
•TMZ e PCV nessuno dei due è superiore all’altro. TMZ è più tollerato
Alto grado (G3, anaplastici) -Chirurgia +RT (60Gy convenzionale)
—> mantenimento: TMZ (maggior vantaggio nei codeleti —> oligodendrogliomi) Se facessi RT + CT concomitante non avrei beneﬁcio. Con TMZ di mantenimento miglioro l’OS di 5aa perché prolunga il Relapse Free Survival
RM post-chirurgica per esito chirurgico e dopo 4w per valutare recidiva
Recidiva: -Pazienti con astrocitomi diﬀusi recidivati, con comparsa di enhancement o ancora sintomatici dopo radioterapia possono trarre beneﬁcio da una eventuale Nuova chirurgia, se appropriata, e da un trattamento chemioterapico con Nitrosouree (Lomustina) o Temozolomide. Le risposte cliniche e/o radiologiche si possono veriﬁcare anche dopo molti mesi di terapia.
-In pazienti recidivati o in progressione dopo PCV, Temozolomide ha ottenuto una percentuale di risposte sovrapponibile al PCV ma con minore tossicità. Pazienti in progressione sia a PCV che Temozolomide possono ottenere stabilizzazioni anche di lunga durata con Carboplatino ed Epipodoﬁllotossine (Etoposide)
Glioblastomi: Chirurgia + Schedula di Stupp: RT (60Gy convenzionale) + TMZ concomitante 75mg/mq (ogni giorno) + (dopo la fase di CTRT) TMZ 150mg/mq (5 giorni al mese per 6 mesi a dosaggio raddoppiato)
La TMZ adiuvante migliora l’OS (anche se secondo me questa è una CT di mantenimento ma anche nelle slide dice adiuvante)
—> pazienti con metilazione promoter MGMT 	 ASSOCIARE Lomustina (doppia terapia alchilante), solo nei pazienti ﬁt-	 		 giovani
—> pazienti anziani defedati (>65-70aa) 	 Invece della TMZ —> Ipofrazionamento: 40Gy in 15 sedute (la TMZ può 	 		 essere comunque valutata)
—> pz non operabili:
	 Si può provare RT ipofrazionata + TMZ
Non operabilità dipende da: Sede (es. Oltre la linea mediana), Dimensioni e Karnofsky <70
Pz non operabile ha una prognosi di 3 mesi con terapia palliativa. In alcuni la RT ipofrazionata + TMZ funziona
Recidiva: -In pazienti con un buon performance status può essere considerato l’utilizzo del REGORAFENIB al momento della recidiva dopo trattamento standard di prima linea radiochemioterapico con temozolomide. Ulteriori alternative terapeutiche sono costituite dal trattamento con Fotemustina o con altre Nitrosouree (Lomustina in monoterapia o schema PCV) e l’inclusione del paziente in sperimentazioni cliniche. Inoltre, in pazienti con intervallo libero di molti mesi dopo terapia adiuvante con Temozolomide, il ritrattamento con Temozolomide può anche essere considerato.
-BEVACIZUMAB è stato approvato dalla Food and Drug Administration per il trattamento nella recidiva di glioblastoma. Sostanziale sovrapponibilità di sopravvivenza rispetto alle nitrosouree.
-Il REINTERVENTO può rappresentare un’opzione, ma è spesso gravato da maggiore morbilità in rapporto all’estensione di malattia e ai trattamenti precedenti e non vi sono chiari dati in termini di impatto sulla sopravvivenza. Parametri predittivi di una maggiore sopravvivenza e qualità di vita: età <70 anni, Karnofsky (KPS) >70, istologia non glioblastoma, intervallo dal primo intervento >6 mesi, assenza di deﬁcit neurologici
-Il DEVICI NovoTTF è un dispositivo che attraverso elettrodi posti sul cuoio capelluto dovrebbe contrastare la crescita del glioblastoma attraverso meccanismi elettroﬁsici
MEDULLOBLASTOMA: Diﬀerenziazione neuronale
Basso rischio (PFS 80%): Not Large cell/Anaplastic, B catenina +, No MYC ampliﬁcation, R0, M0, Età >3aa,
Alto rischio (PFS 30%): Large cell/Anaplastic, MYC ampliﬁcation, R1 (>1,5cc (credo R2)), Classiﬁcazione di Chang 1-2-3-4 (metastasi), Età < 3aa,
Standard rischio (PFS 60%): Intermedio (M0 e Residuo post-operatorio piccolo)
Chirurgia: —> dopo la chirurgia si eﬀettua in 24/48h RM x esito chirurgico poi una RM 		 spinale dopo 2w dall’operazione e un citologico su LCS
+ RT cranio-spinale:
	 —> basso rischio: 18Gy (10 sedute x 1,8Gy) o Non irradiare
	 —> rischio standard: 23,4Gy (13 sedute x 1,8Gy)
	 —> alto rischio: 36Gy (20 sedute x 1,8Gy)
+ Concomitante Vincristina
+Boost cavità chirurgica sequenziale: 55,8Gy x 31frazioni 1,8Gy (Sia rischio standard che alto rischio)
+“PCV modiﬁcato” adiuvante: Cisplatino + Lomustina + Vincristina (al posto di Procarbazina) x 8 Cicli
Localizzazione metastasi: Asse spinale (midollo spinale + Leptomeningi)
MENINGIOMA: (ha 3 stadi) Cellule della granulazione aracnoidea nelle meningi
-La presentazione clinica ha due quadri tipici:
•Crisi epilettica: in seguito alla crescita del meningioma c’è un’irritazione della corteccia cerebrale sottostante che a lungo andare induce la crisi.
•Sintomatologia da eﬀetto massa: cefalea e sintomi correlati
G1:
—> Asintomatico: Follow-up
—> Sintomatico e/o eﬀetto massa: (indipendentemente dalle dimensioni?) 	Chirurgia
o RT stereotassica ablativa (esclusiva) a 14-15Gy  se:
•Paziente non ﬁt
•Dimensioni ridotte <3cm
•Sede critica come il basicranio per coinvolgimento dello sfenoide 
•Piccola recidiva dopo 5aa da chirurgia
G2: 
Chirurgia con Resezione radicale:
—> Follow-up o RT adiuvante
G1-2 se R1 o G3 (sempre): Chirurgia + 	RT adiuvante 60Gy
•Nel pz G2 operati radicalmente RT adiuvante ha eﬀetti positivi su: Recidiva e PFS (Non su OS)
Metastasi:
	RT stereotassica ablativa (esclusiva) a 21Gy
EPENDIMOMI: Glia specializzata: Cellule ependimali
Tappezzano interamente il canale ependimale e nei ventricoli modiﬁcano e formano i “plessi coroidei” che producono il liquor
Chirurgia: primo step in tutti i Gradi
G2:
R0 —> Non RT adiuvante se:
•Ependimomi spinali
•Ependimomi sovratentoriali
+ RT adiuvante 54/55Gy se:
•R1 o Sottotentoriale
G3:
+ RT adiuvante 60Gy 2Gy/Fr o 59,4Gy 1,8Gy/Fr
-Whole brain RT: solo in caso di metastasi spinale accertata
Ependimoma mixopapillare: metastasi per via liquorale, poichè di norma cresce a stretto contatto con il liquido cefalorachidiano e talvolta le cellule neoplastiche possono inﬁltrare il liquor e dare impianti a distanza (la malattia diventa multifocale). In questo caso è necessaria la stadiazione tramite RM ancor prima dell’intervento chirurgico, proprio per capire se è già iniziata la disseminazione
In generale le metastasi di K SNC sono da diﬀusione locale/cerebrospinale quasi mai sistemiche
Medulloblastoma disseminazione leptomeningea
Basso grado:
T2-Flair: iperintensità a causa dell’alta cellularità della massa tumorale. Assenza di margini tumorali netti
T1: Ipointensi a causa di un’anomala cellularità e scarso contenuto di Lipidi/Mielina
Scarsa captazione di mdc nelle forme a basso grado
Alto Grado:
La compressione derivante dall’alta proliferazione cellulare determina margini netti.
Vascolarizzazione e edema perilesionale conferiscono un’importante presa di mdc
Necrosi centrale
NEN: -SSRAs: 
•Octreotide e Lanreotide
GEP-NET: (G1-G2-G3) -GEP-NEN basso grado (ben diﬀerenziati), SSTR+:
•Analoghi del recettore della somatostatina (SSRAs): Octreotide e Lanreotide
•Short acting: sindrome non controllata iniziare con <—
•Long acting
•Farmaci biologici: Everolimus e Sunitinib
-NET-Inoperabile, Alta espressione SSTR:
•Peptide receptor radionuclide therapy PPRT: •90Y-DOTA-Tyr3-Octreotide
•90Y-DOTA-TOC
•177-Lu-DOTA-TATE
-CT: In pz già trattati. In schedula metronomica -Cisplatino, 5-Fluorouracile, Doxorubicina
-Temozolomide + Capecitabina
-FOLFOX, GEMOX
GEP-NEC: -Chemioterapia:
•Etoposide + Carboplatino (o Cisplatino)
•5-Fluorouracile
•Capecitabina
•Oxaliplatino
•Ironotecan
...
•PPI
•SSRA
•Resezione endoscopica di: Lesione + Gastrinoma
-Tipo 3:
•SSRA
•Chemioterapia (Se G2 che progrediscono dopo SSRA e NEC)
•Gastrectomia + Linfadenectomia
NEN-Pancreatici: -Piccole dimensioni non funzionanti: <2cm
•Follow-up
-Piccole dimensioni funzionanti: <2cm
•Resezione
-Grandi: >2cm
•Duodenocefalopancreasectomia o splenopancreasectomia distale
•Se MEN1 follow-up
-Se metastasi epatiche: (SE: assenza di malattia extra-addominale, Ki67 <20%, SSTRs+ alla PET 68Ga
•RFA se <3cm e <2-3 (intento radicale)
•TACE o TARE (intento di debulking) in pz con
•Ci sono studi a favore del Trapianto
NEN-Colon-Rettali: -Colon: •Basso/Intermedio grado e <2cm: Rimozione endoscopica •Alto e >2cm: Resezione chirurgica
-Retto: •Basso gradio <1cm: Rimozione endoscopica
•Tutti gli altri: Resezione chirurgica
NET-Toracici: -Carcinoidi stadio iniziale N2:
•Sleeve lobectomia
•Pneumonectomia
•Carcinoidi tipici:
•SSRA e se progressione —> Everolimus
•Temozolomide
•FOLFOX
•Carcinoidi atipici:
•Analoghi delle pirimidine
-LCNEC (Large cells NEC):
•Lobectomia
•Chemioterapia adiuvante
•Stadio III: CTRT (non operabile)
Carcinoma a cellule di Merkel: -Stadi precoci: •Chirurgia con ampi margini + Linfonodo sentinella (se linfonodi non clinici)
•Dissezione linfonodale locoregionale
•Valutare caso per caso RT adiuvante (tranne per Stadio I T<2cm,N0)
•Chemioterapia adiuvante NO
•Isolated limb perfusion con:
•Interferone + Melphalan + TNF
-Malattia localmente avanzata (è inoperabile): •CTRT
-Malattia avanzata (metastatica):
•Cisplatino/Carboplatino + Etoposide
•Schema CAV: Ciclofosfamide + Adriamicina + Vincristina
•Doxorubicina
•Dacarbazina
•Metotrexato
•Avelumab Sindrome da carcinoide: Terapia Crisi da carcinoide —> SSRA short acting + correzione disturbi elettrolitici, acidosi e terapia di supporto
Terapia sindrome da carcinoide in generale: SSRA long acting
Terapia NEN di base
Diarrea: Telotristat
Sarcomi: -Metastasi:
•Polmoni
•Fegato
•Ossa
-Principali sedi di sarcomi:
•Braccia-Gambe: 60%
•Tratto GI: 25%
•Retroperitoneale e Intra-addominale:15-20%
•Testa-Collo: 9%
Sarcomi arti e parete toracica: Vanno indagate masse profonde o superﬁciali se >5cm 
-CTRT neo-adiuvante: concomitante
 —> Epirubicina + Fosfamide (Ifosfamide) x 3gg
 +
—> Radioterapia 50Gy in 25 frazioni 2Gy/fr
-Stadio 1 G1:
•Chirurgia + •Margini inadeguati (intralesionali) —> Re-Intervento (dopo di che come margini adeguati)
•Margini adeguati —> Follow-up (se confermato il G1) o Radioterapia adiuvante
-Stadio 2-3 G2-3:
-Resecabile ma con buon risultato funzionale —> Chirurgia + CTRT adiuvate o RT adiuvante
-Resecabile ma con cattivo risultato funzionale —> CT pre-operatoria +/- e/o RT pre-operatoria —> Se Operabile Chirurgia Se Non Operabile CT
RT adiuvante: 55Gy 1,8-2Gy/fr + Dose Boost 66Gy
La RT adiuvante è preferita in prevalentemente in Stadio 2-3 G2-3 quindi in caso di Sedi profonde e Diametro > 5 cm
Faccio la CT adiuvante in pz ad alto rischio di progressione (e solo alto grado?): età, grado, istotipo e dimensioni
Sarcomi mammari: Chirurgia: -R0:
•Margini <1cm (<3cm se angiosarcoma):
	 <5cm/alto grado —> RT (no se tumore ﬁlloide) +/- CT —> Follow-up a 3-6m
	 <5cm —> Follow-up a 3-6m
•R1-2 o R0 con Margini >1cm (>3cm se angiosarcoma):
	 Valutazione multidisciplinare:
	 SE operabile si torna a capo
	 Se non operabile —> CT +/- RT —> Valutazione multidisciplinare —> 	 		 operabile si torna a capo Altrimenti Eventuale ulteriore CT o Follow-up a 	 		 3-6m
Sarcomi retroperitoneali: CTRT neo-adiuvante + Chirurgia
Talvolta si può valutare la CT adiuvante
Sarcomi utero: SE diagnosi pre-intervento:
CTRT neo-adiuvante + Isterectomia +/- Annessiectomia
Annessiectomia si: pz in peri-/-menopausa, Tumore ormono sensibile
Annessiectomia no: 
Chirurgia conservativa:
•In donne nullipare desiderose di prole, giovani (<40 anni) con tumore di dimensioni < 5 cm (stadio IA)
Malattia avanzata metastatizzata:
•Metastasectomia polmonare in malattia conﬁnata nel polmone dovrebbe essere presa in considerazione come prima opzione, purché l’intervento sia fattibile in maniera completa e funzionalmente accettabile
•La Chemioterapia complementare alla Chirurgia può essere proposta in base ai fattori di rischio (numero delle lesioni operate ed intervallo libero da pregressi trattamenti). Se ritenuta indicata può essere eﬀettuata almeno in parte prima della Chirurgia, con il potenziale vantaggio di valutare con la risposta tumorale la sensibilità del tumore e di conseguenza di modulare l’ulteriore trattamento.
•Nelle metastasi polmonari metacrone resecate una chemioterapia non dovrebbe essere presa in considerazione
Malattai metastatica non resecabile:
-CT: •Doxorubicina •Doxorubicina + Ifosfamide •Doxorubicina + Dacarbazina
-Chemioterapia combinata in I Linea se pz Fit
•Dacarbazina preferita nel leiomiosarcoma
•Ifosfamide in tutti gli altri
-La combinazione migliora la PFS e l’OS
GIST: -Metastasi:
•Epatiche
•Peritoneali
•Polmonari
Palliativa: Metastasi ossee: -30Gy / 10 fr
-24Gy / 6 fr
-20 Gy / 5 fr
-8Gy / 1fr
-8Gy in singola seduta (anche per due volte)(funziona in modo analogo al classico 30Gy in 10fr) SE NON complicate:
•Assenza di compressione midollare
•Senza necessità di stabilizzazione chirurgica
-Lesione oligometastatica:
•18-20Gy in singola seduta/poche sedute
-Laminectomia decompressiva:  A scopo decompressivo e/o Di Chirurgia di separazione + RT con minore urgenza
-Re-irradiazione con 8Gy se recrudescenza antalgica
Metastasi cerebrali: -Metastasi multiple sintomatiche:
•Whole brain RT: 
•30Gy / 10fr
•20 Gy / 5 fr
•37.5 Gy / 15 fr
•In pz complessi si può non fare
•Da prediligere in pz giovani e soprattutto oligometastatici (≤3 Lesioni)
-Singola metastasi:
•Chirurgia: lesione molto grossa in sede non molto eloquente
•Radiochirurgia: Lesione molto piccola in sede profonda
La lesione neoplastica ideale per la radiochirurgia:
•Nessuna invasione cerebrale
•Margini ben demarcati individuabili al Neuroimaging
•Tumore sferico <2,5-3cm
-Radiochirurgia:
•<2 cm 1 x 21 Gy
•2-3 cm 1 x 18 Gy
•>3cm 3 x 8 Gy
•Oligometastatica ≤4 lesioni : SRS + TKI
•Metastasi multiple, grandi e sintomatiche: WBI + TKI
• Metastasi multiple, asintomatiche e piccole: TKI da solo con controlli ravvicinati per progressione intracranica per eventualmente —> WBRT di salvataggio
